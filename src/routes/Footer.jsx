  ...
  <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
    ...
    <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
     <li>
                ...
                <li>
                  <Link to="/preguntas-frecuentes" className="text-white transition no-underline " href="#"> Preguntas Frecuentes </Link>
                </li>
                ...
                <li>
                  <Link to="/contactos" className="text-white transition no-underline " href="#"> Contactos </Link>
                </li>
    </ul>
